...
def process_user_choice(choice, person):
    if choice == 1:
        print("Ваш баланс равен:", check_account(person))
    elif choice == 2:
            ...
            if person and is_pin_valid(person, pin_code):
                while True:
                    try:
                        ...
                        print("Команда должна содержать ТОЛЬКО цифру!")
            else:
                print('Номер карты или пин код введены не верно!')
        except ValueError:
            print("Вы должны ввести номер карты и пин код!")
            print("Карта и пин код должны содержать ТОЛЬКО цифры и быть разделены ПРОБЕЛОМ!\n")
